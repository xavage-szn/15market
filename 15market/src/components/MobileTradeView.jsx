    ...
    const draw = () => {
      ...
      if (trades && trades.length > 0) {
        trades.forEach(trade => {
          ...
          const badgeY2 = Math.max(8, Math.min(rawBadgeY, H - badgeH2 - 8));
          const lineTop = badgeY2 + badgeH2;
...
export default function MobileTradeView({
  ...
  return (
    ...
    >
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full overflow-hidden flex items-center justify-center bg-black/5 dark:bg-white/10">
                        {logo ? (
                          <img src={logo} alt={t.symbol} className="w-8 h-8 object-contain" style={{ filter: getLogoFilter(isLight) }} />
                        ) : (
      ...
      <div className="flex-1 min-h-[220px] w-full relative pt-1 pb-1" style={{ overflow: 'visible' }}>
