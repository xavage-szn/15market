            ...
            `}>
                ...
                >
                    <div className="flex flex-col items-center gap-8">
                        <History size={20} className={isOpen ? 'text-[#3CB371]' : 'text-white/40 group-hover:text-white'} />

                        <div className="flex items-center gap-2" style={{ writingMode: 'vertical-rl', transform: 'rotate(180deg)' }}>
                            <span className={`text-[10px] font-black uppercase tracking-[0.2em] ${isOpen ? 'text-white' : 'text-white/40 group-hover:text-white'}`}>
                                History
                            </span>
                        </div>
                                        ...
                                        return (
                                            <div
                                                ...
                                                className={`
                                                    ...
                                                    ${isDark ? 'bg-white/5 border-white/5 hover:border-white/10' : 'bg-black/5 border-black/5'}
                                                `}
                                            >
                                                ...
                                                <div className="flex items-center justify-between">
                                                    <div className="flex flex-col">
                                                        <span className="text-[10px] text-white/40 font-medium">Entry: ${trade.entryPrice}</span>
