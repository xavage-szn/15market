...
contract ArcPrediction is Ownable, ReentrancyGuard {
    ...
    function placeBet(uint8 _direction, uint256 _duration, uint256 _entryPrice, uint8 _marketId) external payable nonReentrant {
        ...
        emit BetPlaced(betId, msg.sender, msg.value, _direction, _entryPrice, _duration, block.timestamp, _marketId);
    }
