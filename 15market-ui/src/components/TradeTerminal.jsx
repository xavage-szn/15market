...
const TradeTerminalComponent = ({
    ...
    return (
        <div className={`col-span-1 lg:col-span-12 xl:col-span-7 p-2.5 lg:p-6 rounded-[24px] lg:rounded-[32px] border relative overflow-hidden transition-colors duration-300 ${isLight ? 'static-panel-light !shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)]' : 'bg-[#050505] border-white/10'}`}>
