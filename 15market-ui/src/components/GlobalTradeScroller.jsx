                            ...
                            {repeatedHistory.map((event, i) => (
                                <div key={`${event.id}-${i}`} className="flex items-center mx-4 lg:mx-8">
                                    <div className={`flex items-center gap-3 lg:gap-4 px-3 py-1 lg:px-4 lg:py-1.5 rounded-xl border-2 transition-all duration-300 hover:scale-[1.02] ${event.direction === "UP"
                                        ? (theme === 'light' ? 'border-[#3CB371] shadow-[0_0_20px_rgba(60,179,113,0.5)] bg-transparent backdrop-blur-sm' : 'border-[#3CB371]/60 shadow-[0_0_25px_rgba(60,179,113,0.3)] bg-[#3CB371]/5')
                                        : (theme === 'light' ? 'border-[#FF8C00] shadow-[0_0_20px_rgba(255,140,0,0.5)] bg-transparent backdrop-blur-sm' : 'border-[#FF8C00]/60 shadow-[0_0_25px_rgba(255,140,0,0.3)] bg-[#FF8C00]/5')
